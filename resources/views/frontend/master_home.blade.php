...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="index.html" class="logo" style="font-family: 'Righteous', cursive;text-transform: capitalize;">Lift<em> Up</em> <i class="fas fa-dumbbell"></i></a> 
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; 2020 Jogindrakumar <a rel="nofollow" href="https://jogindrakumar.com" class="tm-text-link" target="_parent">JK</a></p>
